...
public  class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(getActivity()!=null)
        {
            ...
            Imageloader adapter = new Imageloader(getActivity(),array,width);
    ...
    public void onStart()
    {
        ...
        if(sortByFavorites)
        {
            ...
            {
                Imageloader adapter = new Imageloader(getActivity(),postersF,width);
                gridview.setAdapter(adapter);
            }
    ...
    {
        String URL = "content://com.example.sos.mymovies.Database/movies";
        ...
        while(c.moveToNext())
        {
            postersF.add(c.getString(c.getColumnIndex(Database.NAME)));
            commentsF.add(convertStringToArrayList(c.getString(c.getColumnIndex(Database.REVIEW))));
            titlesF.add(c.getString(c.getColumnIndex(Database.TITLE)));
            overviewsF.add(c.getString(c.getColumnIndex(Database.OVERVIEW)));
            youtubesF.add(c.getString(c.getColumnIndex(Database.YOUTUBE1)));
            youtubes2F.add(c.getString(c.getColumnIndex(Database.YOUTUBE2)));
            datesF.add(c.getString(c.getColumnIndex(Database.DATE)));
            ratingsF.add(c.getString(c.getColumnIndex(Database.RATING)));
            favorited.add(true);
    ...
    public class ImageLoadTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected void onPostExecute(ArrayList<String>result)
        {
            ...
            {
                Imageloader adapter = new Imageloader(getActivity(),result, width);
                gridview.setAdapter(adapter);
